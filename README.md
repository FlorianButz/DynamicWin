...
> [!NOTE]
> I am [59xa](https://github.com/59xa), the current maintainer and developer for DynamicWin. While [FlorianButz](https://github.com/FlorianButz) discontinued this project for the time being, expect updates and features within my [repository](https://github.com/59xa/DynamicWin) instead before they get merged into the [main repository](https://github.com/FlorianButz/DynamicWin).
